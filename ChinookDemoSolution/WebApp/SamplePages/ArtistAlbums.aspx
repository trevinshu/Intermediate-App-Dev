...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="ArtistAlbumsList" runat="server" AutoGenerateColumns="False" DataSourceID="ArtistAlbumsODS" AllowPaging="True">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ArtistAlbumsODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_GetArtistAlbums" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
</asp:Content>
